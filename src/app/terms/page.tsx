          ...
          {[
            {
              ...
              content:
                "By accessing and using RideEx, you accept and agree to be bound by the terms and provisions of this agreement. If you do not agree to abide by the above, please do not use this service.",
            },
            {
              title: "2. Service Description",
              content:
                "RideEx is a Moto freight and logistics company that connects users with a wide range of services, including restaurants, fruit, grocery and supermarket, pharmacy, and health. We facilitate the ordering, delivery, and logistics of goods and services through our mobile application and efficient motorcycle-based transport network.",
            },
            {
              title: "3. User Responsibilities",
              content:
                "Users are responsible for providing accurate information when placing orders, maintaining the security of their account credentials, and complying with all applicable laws and regulations.",
            },
            {
              title: "4. Payment Terms",
              content:
                "All payments must be made through the approved payment methods available on the platform. Users agree to pay all charges incurred under their account, including applicable taxes and delivery fees.",
            },
            {
              title: "5. Delivery Policy",
              content:
                "Delivery times are estimates and may vary based on location, weather conditions, and preparation or processing time. RideEx is not responsible for delays beyond our reasonable control.",
            },
            {
              title: "6. Cancellation and Refunds",
              content:
                "Orders may be cancelled within a limited time frame after placement. Refund policies vary by service provider and circumstances. Please refer to our refund policy for detailed information.",
            },
            {
              title: "7. Privacy and Data Protection",
              content:
                'We are committed to protecting your privacy and personal information. Please review our <a href="/privacy" className="text-orange-600 dark:text-orange-400 underline hover:text-red-600 dark:hover:text-red-400 transition-colors">Privacy Policy</a> to understand how we collect, use, and protect your data.',
            },
            {
              title: "8. Limitation of Liability",
              content:
                "RideEx shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses.",
            },
            {
            ...
            },
            {
              ...
              content:
                'For questions about these Terms and Conditions, please contact us at <a href="mailto:support@rideexapp.com" className="text-orange-600 dark:text-orange-400 underline hover:text-red-600 dark:hover:text-red-400 transition-colors">support@rideexapp.com</a> or <a href="tel:+2347072087857" className="text-orange-600 dark:text-orange-400 underline hover:text-red-600 dark:hover:text-red-400 transition-colors">+234 707 208 7857</a>.',
            },
          ].map((section, index) => (
